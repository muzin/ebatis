...
SqlChain.prototype.config = {};

SqlChain.prototype.initTransition = false;
 ...
 * @returns {*}
 */
SqlChain.prototype.findOne = function findOne(sql, val, cb){
    var _self = this;
 ...
 * @returns {Promise<any>}
 */
SqlChain.prototype.findOne.promise = function(sql, val) {
